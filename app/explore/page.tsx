...
type ExploreProps = { searchParams?: Promise<{ sort?: string; q?: string; verified?: string }> };
...
export default async function ExplorePage({ searchParams }: ExploreProps) {
  ...
  return (
    <section className="container-main py-12">
      <SectionHeading title="Explore Ton Gemz" subtitle="Browse today's best, all-time leaders, new listings, and verified projects." />
