  ...
  return (
    <div className="card p-4 transition duration-200 hover:-translate-y-1 hover:border-cyan-400/35 hover:shadow-glow">
      ...
      <div className="mt-5 flex items-center justify-between gap-3">
        ...
        <Link href={`/token/${encodeURIComponent(token.id)}`} className="inline-flex items-center gap-1 text-sm text-cyan-300 hover:text-cyan-200">View <ArrowUpRight className="h-4 w-4" /></Link>
      </div>
    </div>
  );
}
