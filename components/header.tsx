    ...
    <header className="sticky top-0 z-40 border-b border-stroke/70 bg-[#040814]/92 backdrop-blur-2xl">
      <div className="border-b border-fuchsia-400/20 bg-gradient-to-r from-fuchsia-500/70 via-violet-500/55 to-cyan-400/30">
        <div className="container-main flex items-center justify-between gap-2 py-1 text-[9px] uppercase tracking-[0.16em] text-white/90 sm:text-[10px]">
          ...
          <Link href="/banner-ads" className="inline-flex min-w-[124px] items-center justify-center rounded-full border border-lime-300/45 bg-lime-400/90 px-3 py-1 text-[9px] font-bold uppercase tracking-[0.14em] text-slate-950 transition hover:bg-lime-300 sm:min-w-[138px]">
            Book banner
          </Link>
        </div>
      </div>
      ...
      <div className="container-main py-1.5">
        <div className="mx-auto flex min-h-[54px] max-w-6xl items-center justify-between gap-2 overflow-hidden">
          ...
          <div className="hidden flex-1 px-4 md:block lg:px-8">
            <form action="/explore" method="get">
              <div className="mx-auto flex max-w-xl items-center gap-2 rounded-[22px] border border-stroke/80 bg-card/65 px-4 py-3 shadow-soft">
                ...
                <input type="text" name="q" placeholder="Search tokens by name, symbol or address" className="w-full bg-transparent text-sm text-white outline-none placeholder:text-slate-500" />
              </div>
            </form>
          </div>
          ...
          <Link href="/submit" className="rounded-[20px] border border-cyan-400/55 bg-gradient-to-r from-fuchsia-500/15 via-violet-500/10 to-cyan-400/10 px-4 py-2 text-center text-sm font-medium text-white shadow-[0_0_20px_rgba(34,211,238,0.10)] transition hover:border-cyan-300/80 hover:bg-cyan-400/10 sm:px-5 sm:py-2.5">
            Submit
          </Link>
        </div>
      </div>
